...
public class MyParser/*@bgen(jjtree)*/implements MyParserTreeConstants, MyParserConstants {/*@bgen(jjtree)*/
 ...
 jjtree.openNodeScope(jjtn000);Token t;
  ...
  static final public void waitD() throws ParseException {
 /*@bgen(jjtree) waitD */
 ASTwaitD jjtn000 = new ASTwaitD(JJTWAITD);
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);Token t;
    try {
      t = jj_consume_token(WAITD);
                  jjtree.closeNodeScope(jjtn000, true);
                  jjtc000 = false;
                  jjtn000.value = t.image.toString();
    } finally {
  ...
  static final private int[] jj_la1 = new int[431];
  ...
  public MyParser(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 431; i++) jj_la1[i] = -1;
