/* Generated By:JJTree: Do not edit this line. ASTt.java Version 4.3 */
...
public
class ASTt extends SimpleNode {
  public ASTt(int id) {
    super(id);
  }

  public ASTt(MyTest p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=84a14f8f31592a23d5e103cd41219e55 (do not edit this line) */
